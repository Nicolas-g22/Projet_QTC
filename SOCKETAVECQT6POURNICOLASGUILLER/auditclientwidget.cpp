    ...
    ,socketDeDialogueAvecServeur(new QTcpSocket(this))
{
    ...
    ui->lineEditAdresseIP->setText("172.18.58.70");
    ui->lineEditPort->setText("5555");
...
void AuditClientWidget::onQTcpSocketStateChanged(QAbstractSocket::SocketState socketState)
{
    switch(socketState){
        ...
        case QAbstractSocket::HostLookupState :ui->textEditEtat->append("The socket isp erforming a host name lookup.");break;
